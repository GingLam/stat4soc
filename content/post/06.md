...
![理解基尼系数](https://stat4soc.netlify.app/images/6.5.png)
...
![理解基尼系数](https://stat4soc.netlify.app/images/6.6.png)

* 中国的基尼系数
	* Xie, Yu, Xiang Zhou, “Income inequality in today’s China”, PNAS, 2014,111(19).
 
 ![理解基尼系数](https://stat4soc.netlify.app/images/6.7.png)
...
* 基尼系数的第二种计算方法：
	* 针对计算基尼系数的变量，根据其取值(\\(t\\))的分布，排除负数值或缺失值样本
	* 对该变量取值进行升序排序，并生成个案排序编号(\\(i\\))（注意，并非变量的“秩”）
	* 计算实际样本总量(\\(N\\))
...
![理解基尼系数](https://stat4soc.netlify.app/images/6.8.png)
...
![理解基尼系数](https://stat4soc.netlify.app/images/6.9.png)
...
![理解基尼系数](https://stat4soc.netlify.app/images/6.10.png)
