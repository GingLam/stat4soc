...
#### 案例（1-1）：以2015年主职总收入为例，试检验不同季节出生的劳动者的平均主职收入是否相等
	* 虚无假设H0：不同季节出生的劳动者在2015年拥有相同的主职总收入
	* 研究假设H1：不同季节出生的劳动者在2015年拥有不同的主职总收入
...
begin gpl 
	...
	GUIDE: text.title(label("2015年出生季节劳动者的主职总收入")) 
...
#### 案例（1-1-5）：试用方差分析，检验不同季节出生劳动者，其主要职业收入是否存在差异
* 计算所有劳动者的主要职业收入（取对数）均值
```
aggregate 
	/log_income_mean = mean(log_income).
```
* 计算所有劳动者的主要职业收入（取对数）的总平方和（SST）.
```
...
compute df_b = 4-1.
```
* 计算所有劳动者的主要职业收入（取对数）的组内平方和（SSW）或残差平方和（SSE）
```
...
descriptives p_value_f
	/statistics mean.
```
* 根据F检验结果，P值等于0.149516153378015且大于0.05的显著性水平，不能拒绝虚无假设，即认为不同季节出生的劳动者在2015年可能拥有相同的主职总收入，也可能拥有不同的主职总收入
...
#### 案例（1-1-6）：试用方差分析，检验不同季节出生劳动者，其主要职业收入是否存在差异
* 采用“单因素ANOVA检验”功能
```
oneway log_income by birthmonth
/plot means.
```
* 根据F检验结果，F值等于1.782，P值等于0.149517且大于0.05的显著性水平，不能拒绝虚无假设，即认为不同季节出生的劳动者在2015年可能拥有相同的主职总收入，也可能拥有不同的主职总收入.


#### 随堂练习：以2015年社会地位得分（I7_10_1）为例，试检验不同地区（东中西）劳动者的平均社会地位得分是否相等.
* 提示：
	* 首先要将省份编码（PROV2016）转为地区编码
...
#### 案例（2-1）：以2015年主职总收入为例，试检验不同季节出生和不同性别的劳动者的平均主职收入是否相等
* 虚无假设H0-1:不同季节出生的劳动者在2015年拥有相同的主职总收入
* 虚无假设H0-2:不同性别的劳动者在2015年拥有相同的主职总收入
* 研究假设H1-1:不同季节出生的劳动者在2015年拥有不同的主职总收入
* 研究假设H1-2:不同性别的劳动者在2015年拥有不同的主职总收入
...
```
* 根据F1检验结果，F1值等于1.709387，P1值等于0.163985且大于0.05的显著性水平，不能拒绝虚无假设1，即认为不同季节出生的劳动者在2015年可能拥有相同的主职总收入，也可能拥有不同的主职总收入
* 根据F2检验结果，F2值等于22.379861，P2值等于0.000003且小于0.05的显著性水平，拒绝虚无假设2，即认为不同性别的劳动者在2015年拥有不相同的主职总收入

#### 随堂练习：以2015年主职总收入为例，试检验不同季节出生和不同政治面貌（I1_6）的劳动者的平均主职收入是否相等
* 提示：政治面貌分为中共党员和非中共党员


#### 3.检验多个独立样本总体均值是否相等（样本组别 >= 3）
#### 案例（3-1）：以2015年主职总收入为例，试检验不同季节出生的劳动者的平均主职收入是否相等
	* 虚无假设H0:不同季节出生的劳动者在2015年拥有相同的主职总收入
	* 研究假设H1:不同季节出生的劳动者在2015年拥有不同的主职总收入
```
select if (I3a_6  > 0).
