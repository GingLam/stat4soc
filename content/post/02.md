...
![语法窗口](https://raw.githubusercontent.com/GingLam/teaching.com/master/R/2.1.png)
...
#### 案例3.1 设置工作目录为“/Users/ginglam/Public/data”
```
...
![工作目录](https://raw.githubusercontent.com/GingLam/teaching.com/master/R/2.2.png)
...
![CLDS](https://raw.githubusercontent.com/GingLam/teaching.com/master/R/2.3.png)
...
![titanic](https://raw.githubusercontent.com/GingLam/teaching.com/master/R/2.4.png)
...
#### 案例6.1 将新导入的"clds2016_i"数据命名为"clds"
```
get file "clds2016_i.sav".
dataset names clds window = front.
```

![激活](https://raw.githubusercontent.com/GingLam/teaching.com/master/R/2.5.png)
...
#### 案例7.1 创建定类变量gender（性别）和定序变量education（教育）
* 注意：变量命名必须为英文字符.
```
string gender (a2).
string education (a2).
...
#### 案例7.3 删除变量gender、education和income
```
...
#### 案例8.1 将变量gender、education和income名称，分别修改为sex、educ和salary
```
...
#### 案例9.1 将变量gender、education和income的类型分别修改为
* gender -> 数字型
* education -> 数字型
* income -> 字符串型
```
...
#### 案例10.1 给变量gender、education和income添加变量标签
* gender -> "您的性别是？"
* education -> "您的教育程度是？"
* income -> "您的收入水平是？"
```
...
![变量标签1](https://raw.githubusercontent.com/GingLam/teaching.com/master/R/2.6.png)

```
* 同时添加或修改多个变量标签
* 语法结构为：variable labels + 变量名1 + "变量标签1" + / + 变量名2 + "变量标签2".
#### 案例10.2 修改变量gender、education和income的变量标签
...
![取值标签](https://raw.githubusercontent.com/GingLam/teaching.com/master/R/2.8.png)
...
#### 案例11.2 同时给变量gender和education添加取值标签
```
...
#### 案例12.1 同时给变量gender、education和income添加测量层次
* gender -> "名义"
* education -> "有序"
* income -> "标度"
```
...
![测量层次](https://raw.githubusercontent.com/GingLam/teaching.com/master/R/2.9.png)
